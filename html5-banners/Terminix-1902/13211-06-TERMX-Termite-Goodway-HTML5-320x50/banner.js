var container, exitBtn, legalBtn, tlMain, width=320, height=50;
...
init = function() { //called from index.html, on pageload
	...
	tlMain = new TimelineLite()
		...
		.set('.cta', 			{left:224, top:7, width:91, height:19, backgroundColor:"#ee7600", borderRadius:"4px", overflow:'hidden'})
		.set('.sprite-ctaTxt', 	{left:4, top:4})
