...
function init() {
  ...
  set(".background", { transformOrigin: "50% 50%" });
  set(".cars", { transformOrigin: "50% 50%" });
  set(".x", { transformOrigin: "50% 50%", scale: 0.7 });
...
function frame1() {
  ...
  var time = 2.0;
  from(".background", time, { scale: 2.0 });
  from(".cars", time, { scale: 2.0 });
  from(".x", time + 0.5, { scale: 5 }, "sineOut");
  ...
  from(".logo", 0.7, { alpha: 0 }, "in", 2.0);
  from(".frame1", 0.7, { alpha: 0 }, "in", 2.0);
  ...
  from(".background", time, { y: 45 }, "inOut", delay);
  from(".cars", time, { y: 45 }, "inOut", delay);
  from(".x", time, { y: 45 }, "inOut", delay);
